...
let SaintParseSmtpAdapter = (adapterOptions) => {
    ...
    const email = new Email({
        views: { 
            root: adapterOptions.templates.templateRoot,
            options: {
                extension: adapterOptions.templates.templateExtension || 'pug'
            }
        },
        message: {
...
module.exports = SaintParseSmtpAdapter;